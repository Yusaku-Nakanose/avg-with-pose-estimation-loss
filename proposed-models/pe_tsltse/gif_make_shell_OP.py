...
# GIFアニメーションを作成する関数を実行する
date = opt.date
create_gif(in_dir="/mnt/feoh-public/sig4share/students/b4/nakanose/b4/data_URMP/Sub-URMP/car_gan/results/" + date + "/test_OP/", out_filename="/mnt/feoh-public/sig4share/students/b4/nakanose/b4/data_URMP/Sub-URMP/car_gan/results/" + date + "/gif_"+opt.inst+"_" + date + "_OP_10000to20000_loop1_quan.gif")
create_gif(in_dir="/mnt/feoh-public/sig4share/students/b4/nakanose/b4/data_URMP/Sub-URMP/car_gan/results/" + date + "/test_OP_white/", out_filename="/mnt/feoh-public/sig4share/students/b4/nakanose/b4/data_URMP/Sub-URMP/car_gan/results/" + date + "/gif_"+opt.inst+"_" + date + "_OP_white_10000to20000_loop1_quan.gif")

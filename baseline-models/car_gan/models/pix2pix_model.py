...
import wandb
wandb.init(project="car-gan-jyuurai", entity="cnkgw")
...
class Pix2PixModel(BaseModel):
    ...
    def forward(self):
        ...
        self.fake_image2 = self.netG2(self.cat_input(self.fake_image1, 2)) #stage2
    ...
    def optimize_parameters(self):
        ...
        ####wanb用(10/28追加)
        #['G_GAN', 'G_L1', 'D_i_real', 'D_i_fake',  'D_v_real', 'D_v_fake']
        wandb.log({"G_GAN": self.loss_G_GAN, 'G_L1':self.loss_G_L1, 'D_real':self.loss_D_real, 'D_fake':self.loss_D_fake,  'Class':self.loss_C_label})
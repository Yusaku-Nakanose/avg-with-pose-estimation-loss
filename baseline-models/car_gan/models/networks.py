...
class Classifier(nn.Module):
    ...
    def __init__(self, pretrained=False, name='C'):
        ...
        #model_file = "../../../../mnt/othel-public/sig4share/students/M2/nakagawa/m1/data_URMP/Sub-URMP/car_gan/results/resnet50_pretrained_model.pth"
...
class NLayer3dDiscriminator(nn.Module):
    ...
    def __init__(self, input_nc=3, ndf=32, n_layers=3, norm_layer=nn.BatchNorm3d, use_attention=True, T=4):
        ...
        self.model = nn.Sequential(
            ...
            #nn.Linear(int((ndf*8)*(T/16)*8*8), 1),
            nn.Linear(1024, 1),
            nn.Sigmoid()
        )

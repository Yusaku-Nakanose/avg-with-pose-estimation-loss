...
class Pix2PixconModel(BaseModel):
    ...
    def backward_D(self):
        ...
        pred_fake = self.netD_i(self.cat_input(fake_image1, 2).detach())
        self.loss_D_fake1_1 = self.criterionGAN(pred_fake, False)
        ...
        pred_real = self.netD_i(self.cat_input(real_AB1, 2))

        self.loss_D_i_real = self.criterionGAN(pred_real, True)
